			...
			<div className="bg-zinc-50 flex md:flex-row flex-col md:w-full w-screen justify-center text-justify md:space-x-36 md:fixed md:h-full h-screen pt-36">
				<div className="md:w-96 h-96 w-full text-sm lg:text-sm md:px-3 p-5 bg-zinc-50 font-roboto">
					...
					<p className="leading-6">
						This is a project I have been working on to show
						some of my web-dev abilities. I am a passionate
						programmer that also is very into astrology. I am
						also in need of some help to make this website
						even better. So if you want and have some
						knowledge we could help each other out. We need
						information about the Zodiac Signs. If you know,
						or know anybody that knows about the signs please
						contact me at{" "}

	...
	return (
		<>
			...
			<section className='h-[100%] bg-zinc-50'>
				<div className="md:gap-x-2 z-10 bg-zinc-50 grid md:grid-cols-4 grid-cols-1 md:fixed md:pb-24 md:p-24 md:pt-24 pt-5 justify-items-center md:gap-8 w-full h-screen text-center font-anton text-4xl text-yellow-400">
					<div className="">
						<button

		...
		<>
			...
			className="grid md:grid-cols-2 grid-cols-1 justify-items-center bg-zinc-50  md:h-screen h-full w-full content-center">
				...
				<div className="text-sm text-justify pl-10 pr-10">
					...
					{virgo.date_range} <br />
					<span className="font-anton">Mood:</span> {virgo.mood}{" "}
					<br />
					<span className="font-anton">Description:</span>{" "}
					{virgo.description} <br />
					...
					<div className={active ? "visible p-5" : "hidden"}>
						...
						{virgoTomorrow.current_date} <br />
						<span className="font-anton">
							Compatibility:
						</span>{" "}
						{virgoTomorrow.compatibility} <br />
						<span className="font-anton">
							Lucky Number:
						</span>{" "}
						{virgoTomorrow.lucky_number} <br />
						<span className="font-anton">
							Lucky Time:
						</span>{" "}
						{virgoTomorrow.lucky_time} <br />
						<span className="font-anton">Color:</span>{" "}
						{virgoTomorrow.color} <br />
						<span className="font-anton">
							Date Range:
						</span>{" "}
						{virgoTomorrow.date_range} <br />
						<span className="font-anton">Mood:</span>{" "}
						{virgoTomorrow.mood} <br />
						<span className="font-anton">
							Description:
						</span>{" "}
						{virgoTomorrow.description} <br />
					</div>
				</div>
			</motion.div>
		</>

			...
			<div className="grid md:grid-cols-2 grid-cols-1 justify-items-center bg-zinc-50  md:h-screen h-full w-full content-center pb-24">
				...
				<div className="text-sm text-justify pl-10 pr-10">
					...
					<div className={active ? "visible p-5" : "hidden"}>
						...
						{aquaTomorrow.current_date} <br />
						<span className="font-anton">
							Compatibility:
						</span>{" "}
						{aquaTomorrow.compatibility} <br />
						<span className="font-anton">
							Lucky Number:
						</span>{" "}
						{aquaTomorrow.lucky_number} <br />
						<span className="font-anton">
							Lucky Time:
						</span>{" "}
						{aquaTomorrow.lucky_time} <br />
						<span className="font-anton">Color:</span>{" "}
						{aquaTomorrow.color} <br />
						<span className="font-anton">
							Date Range:
						</span>{" "}
						{aquaTomorrow.date_range} <br />
						<span className="font-anton">Mood:</span>{" "}
						{aquaTomorrow.mood} <br />
						<span className="font-anton">
							Description:
						</span>{" "}

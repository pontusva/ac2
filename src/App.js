...
function App() {
 ...
 let aquariusApiCallToday = "https://aztro.sameerkumar.website/?sign=aquarius&day=today";
 let aquariusApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=aquarius&day=tomorrow";
 let ariesApiCallToday = "https://aztro.sameerkumar.website/?sign=aries&day=today";
 let ariesApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=aries&day=tomorrow";
 let cancerApiCallToday = "https://aztro.sameerkumar.website/?sign=cancer&day=today";
 let cancerApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=cancer&day=tomorrow";
 let capricornApiCallToday = "https://aztro.sameerkumar.website/?sign=capricorn&day=today";
 let capricornApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=capricorn&day=tomorrow";
 let geminiApiCallToday = "https://aztro.sameerkumar.website/?sign=gemini&day=today";
 let geminiApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=gemini&day=tomorrow";
 let leoApiCallToday = "https://aztro.sameerkumar.website/?sign=leo&day=today";
 let leoApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=leo&day=tomorrow";
 let libraApiCallToday = "https://aztro.sameerkumar.website/?sign=libra&day=today";
 let libraApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=libra&day=tomorrow";
 let piscesApiCallToday = "https://aztro.sameerkumar.website/?sign=pisces&day=today";
 let piscesApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=pisces&day=tomorrow";
 let sagittariusApiCallToday = "https://aztro.sameerkumar.website/?sign=sagittarius&day=today";
 let sagittariusApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=sagittarius&day=tomorrow";
 let scorpioApiCallToday = "https://aztro.sameerkumar.website/?sign=scorpio&day=today";
 let scorpioApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=scorpio&day=tomorrow";
 let taurusApiCallToday = "https://aztro.sameerkumar.website/?sign=taurus&day=today";
 let taurusApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=taurus&day=tomorrow";
 let virgoApiCallToday = "https://aztro.sameerkumar.website/?sign=virgo&day=today";
 let virgoApiCallTomorrow = "https://aztro.sameerkumar.website/?sign=virgo&day=tomorrow";
 ...
 const virgoRequestTomorrow = axios.post(virgoApiCallTomorrow);
  ...
  useEffect(() => {
    axios.all(
      [aquaRequest, aquaRequestTomorrow, ariesRequest, 
      ariesRequestTomorrow, cancerRequest, cancerRequestTomorrow,
      capricornRequest, capricornRequestTomorrow,
      geminiRequest, geminiRequestTomorrow, leoRequest, leoRequestTomorrow,
      libraRequest, libraRequestTomorrow, piscesRequest, piscesRequestTomorrow, 
      sagittariusRequest, sagittariusRequestTomorrow,
      scorpioRequest, scorpioRequestTomorrow,
      taurusRequest, taurusRequestTomorrow,
      virgoRequest, virgoRequestTomorrow]).then(axios.spread((...responses) => {
  ...
  <div>
    <apiContext.Provider value={
      { aqua, aquaTomorrow, 
        aries, ariesTomorrow, 
        cancerSign, cancerTomorrow,
        capricornSign, capricornTomorrow,
        gemini, geminiTomorrow, 
        leo, leoTomorrow, 
        libra, libraTomorrow, 
        pisces, piscesTomorrow,
        sagittarius, sagittariusTomorrow,
        scorpio, scorpioTomorrow,
        taurus, taurusTomorrow,
        virgo, virgoTomorrow }}>
      <Router>
        <Routes>
